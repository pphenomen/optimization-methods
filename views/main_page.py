...
layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col(dbc.Button("Лабораторная работа 5", href="/lr5", color="secondary", className="btn-lg d-grid gap-2"), width=6),
    ], className="mt-4 justify-content-center"),
    dbc.Row([
        dbc.Col(dbc.Button("Лабораторная работа 6", href="/lr6", color="secondary", className="btn-lg d-grid gap-2"), width=6),
    ], className="mt-4 justify-content-center"),
