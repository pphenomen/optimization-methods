    ...
    dbc.Row([
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody([
                    dbc.InputGroup([dbc.InputGroupText("Итерации"), dbc.Input(id='bfoa-iters', type='number', value=50)], className='mb-2'),
                    ...
                    dbc.InputGroup([create_function_dropdown("bfoa-function-selector", default="reverse_sphere")], className='mb-2 text-dark'),
